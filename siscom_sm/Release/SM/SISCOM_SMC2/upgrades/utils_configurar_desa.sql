CALL globalcfg_insert('UPD_URL', 'C', 'D:\\sistemas\\lg-v1-dev\\deploys\\sm\\', 1);
CALL globalcfg_insert('FELOCAL', 'L', 'true', 1);
CALL globalcfg_insert('FETKDIRFTP', 'C', '/var/www/html/wsafip/ticket/desa', 1);

-- Nombre del archivo ejecutable
CALL globalcfg_insert('UPD_EXEC1', 'C', 'siscom_smc1.exe', 1);
CALL globalcfg_insert('UPD_EXEC2', 'C', 'siscom_smc2.exe', 1);
...
CALL agregar_menu('10.13', '\\-', '', 1, 10, '', 10013);
CALL agregar_menu('10.14', 'Consulta de ordenes de pagos', 'DO FORM frm_orden_pago_consulta', 1, 10, '', 10014);

-- Menu automatización de cuentas corrientes.
CALL agregar_menu('5.12', '\\-', '', 1, 5, '', 5012);
CALL agregar_menu('5.13', 'Enviar Resumenes', 'DO FORM frm_envio_resumen_ctactecli', 1, 5, '', 5013);