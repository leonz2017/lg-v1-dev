...
lcSql = rsArtic.addParameter(lcSql, "pBonif1", ALLTRIM(STR(lnBonif1, 10, 2)), .f., .f.)
lcSql = rsArtic.addParameter(lcSql, "pBonif2", ALLTRIM(STR(lnBonif2, 10, 2)), .f., .f.)
lcSql = rsArtic.addParameter(lcSql, "pBonif3", ALLTRIM(STR(lnBonif3, 10, 2)), .f., .f.)
lcSql = rsArtic.addParameter(lcSql, "pBonif4", ALLTRIM(STR(lnBonif4, 10, 2)), .f., .f.)
lcSql = rsArtic.addParameter(lcSql, "pMargenMax", ALLTRIM(STR(lnMargenMax, 10, 2)), .f., .f.)
lcSql = rsArtic.addParameter(lcSql, "pMargenMin", ALLTRIM(STR(lnMargenMin, 10, 2)), .f., .f.)
lcSql = rsArtic.addParameter(lcSql, "pPorVariacion", ALLTRIM(STR(lnPorVariacion, 10, 2)), .f., .f.)
