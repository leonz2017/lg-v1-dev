...
****************************************************************************
** Hago un cambio de conexión en la variable goConn para que funcione la
** pantalla de recibos en cuenta 2 y me pueda cancelar las facturas
****************************************************************************

goConn.Close()
goConn.ConnectionString = getConfig("DMO_CC")
goConn.Open()

ENDPROC
PROCEDURE desconectar_de_c2
************************************************************
* Cierra la conexión a C2 y reestablece la conexión a C1
************************************************************

goConn.Close()
goConn.ConnectionString = getConfig("ODBC_CONN")
goConn.Open()

ENDPROC
PROCEDURE Destroy
If This.conexion_c2 Then
	** Desconecta de C2 y reestablece la conexión con C1 en
	** presupuestos
	This.desconectar_de_c2
EndIf
ENDPROC
PROCEDURE Activate
If This.conexion_c2 THEN
