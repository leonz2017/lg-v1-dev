...
* Obtengo el ID del cliente que está configurado como consumidor final.
lnIdClienteCF = getGlobalCFG("idGlobalCF")
...
lcSql = lcSql + "		AND clientes.idcliente <> " + ALLTRIM(STR(lnIdClienteCF)) + " "
