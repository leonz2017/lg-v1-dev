...
SET PROCEDURE TO "#lfw_updversion_promo.prg" ADDITIVE && Actualización del módulo promociones.
SET PROCEDURE TO "#lfw_updversion_imp_int.prg" ADDITIVE && Actualización del módulo impuestos internos
SET PROCEDURE TO "#lfw_updversion_params.prg" ADDITIVE && Actualización de parametros
SET PROCEDURE TO "#lfw_acomodar_datos.prg" ADDITIVE && Acomoda datos al iniciar el sistema
...
SET PROCEDURE TO "enviar_cbtemail"		ADDITIVE	&& Programa para enviar comprobantes por mail
SET PROCEDURE TO "#bd_update_cajadiaria" ADDITIVE	&& Actualiza la versión del módulo de caja diaria.
...
_screen.Caption = "LINFOW GESTION " + ALLTRIM(lcVersionActual) + " - " + getconfig("NOMEMP") + ;
	" - Usuario Actual: " + ALLTRIM(gcCodUsu) + IIF(glVersionBeta, " - VERSION BETA", "") + " - Pto. Vta.: " + getconfig("PTOVTA")
