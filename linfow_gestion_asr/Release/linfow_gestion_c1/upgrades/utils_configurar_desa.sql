CALL globalcfg_insert('UPD_URL', 'C', 'D:\\sistemas\\lg-v1-dev\\deploys\\tito\\', 1);
CALL globalcfg_insert('FELOCAL', 'L', 'true', 1);
CALL globalcfg_insert('FETKDIRFTP', 'C', '/var/www/html/wsafip/ticket/desa', 1);

-- Nombre del archivo ejecutable
CALL globalcfg_insert('UPD_EXEC1', 'C', 'lfwgest.exe', 1);
CALL globalcfg_insert('UPD_EXEC2', 'C', 'lfwgest_dmo.exe', 1);
...
CALL globalcfg_insert('FCDESC1', 'L', 'false', 1);
