...
SET CLASSLIB TO "articulos_extra.vcx"	ADDITIVE
...
SET PROCEDURE TO "#lfw_updversion.prg"	ADDITIVE	&& Script para actualizar versión
SET PROCEDURE TO "#lfw_acomodar_datos.prg" ADDITIVE	&& Permite acomodar datos en la base
...
* Si Toolbar está habilitado abro la barra lateral con accesos directos.
IF ALLTRIM(lcToolBar) == "ON"
	DO FORM "frmEscritorio"
ENDIF

* Si MODOMOST está en true, entonces muestro la barra superior para actualizar preicos
