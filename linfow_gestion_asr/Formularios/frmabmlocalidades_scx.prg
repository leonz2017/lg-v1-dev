...
************************************************************
OBJETO: FRMABMLOCALIDADES
************************************************************
*** PROPIEDADES ***
DoCreate = .T.
Caption = "ABM Localidades"
cnombretabla = localidad
listctrlsource = CodPostal,Descripcio
listwidthcols = 100,300
obj_dataservicename = datObject
pk_fieldname = idLocalid
titulos_cabeceras = Código Postal,Nombre
Name = "FRMABMLOCALIDADES"
...
ischaracter = .T.
msgerror = Debe ingresar el Nombre de la Localidad
Name = "txtNombre"
...
msgerror = Debe ingresar la Provincia
Name = "sel_Pcia"
...
cfieldname = idPais
esnumerico = .T.
nombre_campo_codigo = idPais
nombre_tabla = paises
pkfield = idPais
nombre_campo_desc = Descripcio
msgerror = Debe ingresar el País
Name = "sel_Paises"
TXTCODIGO.Name = "TXTCODIGO"
TXTDESCRIPCION.Name = "TXTDESCRIPCION"
