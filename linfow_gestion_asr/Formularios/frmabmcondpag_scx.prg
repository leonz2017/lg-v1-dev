...
************************************************************
OBJETO: FRMABMCONDPAG
************************************************************
*** PROPIEDADES ***
DoCreate = .T.
Caption = "ABM Condiciones de Pagos"
listctrlsource = idCondPago,descripcio,CntDias
listwidthcols = 70,100,300
obj_dataservicename = datObject
pk_fieldname = IdCondPago
titulos_cabeceras = Código,Descripción,Cant. Días
cnombretabla = condpagos
Name = "FRMABMCONDPAG"
...
ischaracter = .T.
msgerror = Debe ingresar la descripcion
Name = "txtDescripcio"
...
cfieldname = cntDias
isinteger = .T.
msgerror = Debe ingresar la cantidad de días
requerido = .F.
Name = "txtCntDias"
