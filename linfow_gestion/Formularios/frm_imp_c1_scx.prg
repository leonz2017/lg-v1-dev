...
DO WHILE !EOF("cur_prov")
	...
	IF VAL(cur_tempo.cantReg) = 0 THEN
		...
		lcSql = lcSql + "'" + IIF(ISNULL(cur_prov.telefono), "NULL", ALLTRIM(cur_prov.telefono)) + "', "
		lcSql = lcSql + "'" + IIF(ISNULL(cur_prov.fax), "NULL", ALLTRIM(cur_prov.fax)) + "', "
		lcSql = lcSql + "'" + IIF(ISNULL(cur_prov.eMail), "NULL", ALLTRIM(cur_prov.eMail)) + "', "
		lcSql = lcSql + "'" + IIF(ISNULL(cur_prov.pagWeb), "NULL", ALLTRIM(cur_prov.pagWeb)) + "', "
		lcSql = lcSql + "'" + ALLTRIM(cur_prov.observ) + "', "
		lcSql = lcSql + "'" + IIF(ISNULL(cur_prov.contacto), "NULL", ALLTRIM(cur_prov.contacto)) + "', "
	...
	ELSE
		...
		lcSql = lcSql + "	telefono = '" + IIF(ISNULL(cur_prov.telefono), "NULL", ALLTRIM(cur_prov.telefono)) + "', "
		lcSql = lcSql + "	fax = '" + IIF(ISNULL(cur_prov.fax), "NULL", ALLTRIM(cur_prov.fax)) + "', "
		lcSql = lcSql + "	eMail = '" + IIF(ISNULL(cur_prov.eMail), "NULL", ALLTRIM(cur_prov.eMail)) + "', "
		lcSql = lcSql + "	pagWeb = '" + IIF(ISNULL(cur_prov.pagWeb), "NULL", ALLTRIM(cur_prov.pagWeb)) + "', "
		lcSql = lcSql + "	observ = '" + IIF(ISNULL(cur_prov.observ), "NULL", ALLTRIM(cur_prov.observ)) + "', "
		lcSql = lcSql + "	contacto = '" + IIF(ISNULL(cur_prov.contacto), "NULL", ALLTRIM(cur_prov.contacto)) + "', "
...
DO WHILE !EOF("cur_art")
	...
	IF IIF(INT(VAL(getConfig("SQLSRV"))) = 1, cur_tmp.Cantidad, VAL(cur_tmp.Cantidad)) = 0 THEN
		...
		lcSql = lcSql + "	llevastk, "
		lcSql = lcSql + "	promocion, "
		...
		lcSql = lcSql + ALLTRIM(STR(cur_art.prListaExt, 10, 2)) + ", "
		lcSql = lcSql + ALLTRIM(STR(cur_art.cotizac, 10, 2)) + ", "
		...
		lcSql = lcSql + "'" + IIF(ISNULL(cur_art.observ), "", ALLTRIM(cur_art.observ)) + "', "
		...
		lcSql = lcSql + IIF(cur_art.llevastk, "1", "0") + ", "
		lcSql = lcSql + Iif(cur_art.promocion, "1", "0") + ", "
	...
	ELSE
		...
		lcSql = lcSql + "		observ = '" + IIF(ISNULL(cur_art.observ), "", ALLTRIM(cur_art.observ)) + "', "
		...
		lcSql = lcSql + "		llevastk = " + IIF(cur_art.llevastk, "1", "0") + ", "
		lcSql = lcSql + "		promocion = " + Iif(cur_art.promocion, "1", "0") + ", "
...
DO WHILE !EOF()
	...
	IF IIF(INT(VAL(getConfig("SQLSRV"))) = 1, cur_tmp.CantReg, VAL(cur_tmp.CantReg)) = 0 THEN
		...
		lcSql = lcSql + ALLTRIM(STR(cur_vend.porComis, 10, 2)) + ", "
	...
	ELSE
		...
		lcSql = lcSql + "porComis = " + ALLTRIM(STR(cur_vend.porComis, 10, 2)) + ", "
