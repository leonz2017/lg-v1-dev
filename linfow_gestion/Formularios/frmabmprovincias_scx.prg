...
************************************************************
OBJETO: FRMABMPROVINCIAS
************************************************************
*** PROPIEDADES ***
DoCreate = .T.
Caption = "ABM Provincias"
cnombretabla = provincias
listctrlsource = idprovin,descripcio
listwidthcols = 70,200,70
obj_dataservicename = datObject
pk_fieldname = idprovin
titulos_cabeceras = Código,Nombre
Name = "FRMABMPROVINCIAS"
