CALL globalcfg_insert('UPD_URL', 'C', 'D:\\sistemas\\lg-v1-dev\\deploys\\linfow_gestion\\', 1);
...
CALL `agregar_menu`('4.22', 'Consulta y reimpresión de remitos', 'DO FORM frm_rtos_consulta', 1, 4, '', 4022);

-- Nuevos parámetros (Opciones de recibos)
CALL globalcfg_insert('RCIMPSEL', 'L', 'false', 1);

-- Menues del módulo de reconstrucciones
CALL agregar_menu('14', 'Reconstrucciones', '', 0, 14, '', 14000);
CALL agregar_menu('14.1', 'Estados', 'DO FORM frm_rcn_abm_estados', 1, 14, '', 14001);
CALL agregar_menu('14.3', 'Tipos de remitos', 'DO FORM frm_rcn_abm_tiporemito', 1, 14, '', 14003);
