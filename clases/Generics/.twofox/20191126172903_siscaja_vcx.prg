...
LOCAL lcSql, loResult, loResult2, loDT, loConC1, lbCajaAbierta1, lbCajaAbierta2 
...
loDT = CREATEOBJECT("datetime")
loConC1 = CREATEOBJECT("odbc_connect")
...
loConC1.ConnectionString = ALLTRIM(getConfig("ODBC_C1"))
IF !loConC1.Open() THEN
	MESSAGEBOX(loConC1.ErrorMessage, 0+48, Thisform.Caption)
	RETURN .F.
ENDIF
...
IF lbCajaAbierta1 = .T. THEN 
	...
	loResult.Cursor_Name = "cur_tmp"
	loResult.ActiveConnection = loConC1.ActiveConnection
...
lcSql = lcSql + " WHERE cc_cli.cbte IN ('FC','ND') "
