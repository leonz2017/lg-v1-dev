...
IF tipomov.signo = -1 THEN 	
	lnExistencia = thisform.mov_stock.get_exist_byart(Thisform.contenido.cnt_ingreso.sel_articulo.valcpoid, ALLTRIM(Thisform.contenido.cnt_ingreso.txtNroPart.Value))
