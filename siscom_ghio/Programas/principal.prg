...
SET CLASSLIB TO "logistica.vcx"			ADDITIVE
...
SET PROCEDURE TO "func_dtos"			ADDITIVE
SET PROCEDURE TO "funciones.prg"		ADDITIVE	&& Funciones
SET PROCEDURE TO "#lfw_updversion.prg"	ADDITIVE	&& Actualizar versión
SET PROCEDURE TO "cls_promociones.prg"	ADDITIVE	&& Agrego la clase del módulo de promociones
SET PROCEDURE TO "enviar_mail"			ADDITIVE
SET PROCEDURE TO "cls_planillaprecios.prg" ADDITIVE	&& Agrego clase para planilla DANILO
...
_screen.Caption = "LINFOW GESTION " + ALLTRIM(lcVersionActual) + " - " ;
		+ getconfig("NOMEMP") + " - Usuario Actual: " ;
		+ ALLTRIM(gcCodUsu) + IIF(glVersionBeta, " - VERSION BETA - ", "") ;
		+ " - PTO. VTA.: " + ALLTRIM(getConfig("PTOVTA"))
