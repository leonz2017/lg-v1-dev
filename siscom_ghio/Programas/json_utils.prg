...
*!*	nodo = createobject("nodo")
*!*	lcCadena = strtran(lcJSON, "}", "")
*!*	lcCadena = getwordnum(lcCadena, 2, "{")
*!*	filas = 1
*!*	for i = 1 to getwordcount(lcCadena, ",")
*!*		lcDatos = getwordnum(lcCadena, i, ",")
*!*		if at("[", lcDatos) <= 0 then
*!*			* Aca tengo los datos puros de la cabecera
*!*			nodo.agregarPropiedad(getwordnum(lcDatos, 1, ":"), getwordnum(lcDatos, 2, ":"))
*!*			lcLinea_ppal = lcLinea_ppal + getwordnum(lcDatos, 2, ":") + "|"
*!*		else
*!*			* Si pasa por aca indica que se inicia un subarray
*!*		endif
*!*	endfor

*!*	messagebox(lcLinea_ppal)

*!*	define class nodo as Custom
*!*		procedure agregarPropiedad (tcKey, tcValue)
*!*			tcKey = strtran(tcKey, '"', '')
*!*			if !empty(tcKey) then
*!*				this.AddProperty(tcKey, tcValue)
*!*			endif
*!*		endproc
*!*	enddefine