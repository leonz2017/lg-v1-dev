    ...
    *************************
    ...
    WITH oConnection
      ...
      .TextFileTrailingMinusNumbers = .T.
	    * Lógica genérica para formatear las columnas de tipo 'C' (Carácter) como texto
	    LOCAL lnCampos2, laCampos2[1]
	    lnCampos2 = AFIELDS(laCampos2, cCursor)
	    IF lnCampos2 > 0 THEN
	      FOR i = 1 TO lnCampos2
	        IF ALLTRIM(TYPE('laCampos2(i, 3)')) == "C" THEN
	          .TextFileColumnDataTypes(i) = 2 && 2 = xlTextFormat
	        ENDIF
	      ENDFOR
	    ENDIF      
