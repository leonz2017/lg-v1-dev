...
lcSql = loResult.AddParameter(lcSql, "idVentasC", ALLTRIM(STR(cur_ctacte.idventasc)), .f., .f.)
...
lcSql = loVentas.AddParameter(lcSql, "idVentasC", ALLTRIM(STR(cur_ctacte.idventasc)), .f., .f.)
...
LOCAL m.codigoCbte, m.barcode, m.code, m.nroOC, m.motivo, m.totaNoGrav, m.qr
...
&& Agrego código para obtener el QR
