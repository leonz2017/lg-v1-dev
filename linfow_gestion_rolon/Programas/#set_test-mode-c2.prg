...
goConn.ConnectionString = "DRIVER={MySQL ODBC 5.1 Driver};SERVER=localhost;PORT=3306;UID=root;PWD=l4ld81;DATABASE=linfowgst_rolonc2;OPTION=3;"
...
* URL de actualizador
addOrUpdateGlobalCFG("URLUPDATER", "C", "http://localhost/wp/mgcarburacion/mg_server_updater", .T.)
