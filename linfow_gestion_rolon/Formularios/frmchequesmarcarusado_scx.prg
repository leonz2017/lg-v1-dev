...
************************************************************
OBJETO: FRMCHEQUESCAR
************************************************************
*** PROPIEDADES ***
Height = 220
Width = 669
DoCreate = .T.
Caption = "Ingreso de Cheques Usados"
WindowType = 0
WindowState = 0
Name = "FRMCHEQUESCAR"
...
thisform.contenedor.contenedor1.sel_ClienteDesde.SetFocus()
...
*** METODOS ***
PROCEDURE Click
LOCAL loResult, lcSql, lnIdCli, lcCodBco, lcNroCheque

loResult = CREATEOBJECT("odbc_result")

IF thisform.contenedor.contenedor1.sel_ClienteDesde.valcpoid == 0
	MESSAGEBOX("Debe ingresar el Cliente",0+48,"Ingreso de Cheques Usados")
	return
ELSE
	lnIdCli = thisform.contenedor.contenedor1.sel_ClienteDesde.valcpoid
ENDIF

IF ALLTRIM(thisform.contenedor.contenedor1.sel_BancoDesde.txtCodigo.Value) == ""
	MESSAGEBOX("Debe ingresar el Banco",0+48,"Ingreso de Cheques Usados")
	return
ELSE 
...
IF ALLTRIM(thisform.contenedor.contenedor1.txtNroCheque.Value) == ""
	MESSAGEBOX("Debe ingresar el Nº de Cheque ",0+48,"Ingreso de Cheques Usados")
	return
ELSE
...
lcSql = lcSql + "         and clientes.idcliente = " + ALLTRIM(STR(lnIdCli ))
...
IF RECCOUNT() >0
	thisform.contenedor.contenedor1.txtImporte.Value = cur_chequescar.importe
...
ELSE 
	MESSAGEBOX("El cheque no existe",0+48,"Ingreso de Cheques Usados")
ENDIF 
...
lcSql = lcSql + " WHERE   cheques.estado = 'D' "
lcSql = lcSql + "         and cheques.idcliente = " + ALLTRIM(STR(cur_chequescar.codigo))
lcSql = lcSql + "         and cheques.idbanco = " + ALLTRIM(STR(cur_chequescar.idbanco))
lcSql = lcSql + "         and cheques.chq_nro = '" + cur_chequescar.nrocheque + "'"
...
MESSAGEBOX("El cheque usado se ingresó correctamente",0,"Ingreso de Cheques Usados")
