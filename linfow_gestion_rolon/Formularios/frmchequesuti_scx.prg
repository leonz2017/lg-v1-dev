...
************************************************************
OBJETO: FRMCHEQUESUTI
************************************************************
*** PROPIEDADES ***
Height = 500
Width = 776
DoCreate = .T.
Caption = "Listado de Cheques Utilizados"
WindowType = 0
WindowState = 0
Name = "FRMCHEQUESUTI"
...
lcSql = lcSql + " WHERE   cheques.estado = 'U' "
lcSql = lcSql + "		  and cheques.anulado = 0 "
...
SELECT cur_chequescar
IF RECCOUNT() > 0
	genexcel("cur_chequescar","Listado de Cheques en Utilizados")
ELSE 
...
m.titulo = "Listado de Cheques Utilizados"
SELECT cur_chequescar
