**************************************************
*-- Class Library:  d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx
**************************************************


**************************************************
*-- Class:        cls_update_version (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- ParentClass:  custom
*-- BaseClass:    custom
*-- Time Stamp:   12/02/25 09:08:01 AM
*
DEFINE CLASS cls_update_version AS custom


	*-- Contiene la URL o Ruta de donde buscar la actualización del software.
	url = ""
	*-- Nombre del archivo ejecutable para cuenta 1
	nombre_ejecutable_c1 = ""
	*-- Nombre del archivo ejecutable para cuenta 2
	nombre_ejecutable_c2 = ""
	*-- Indica si se está en modo desarrollo o modo producción.
	modo_desa = .F.
	*-- Ruta actual donde se encuentra instalada la aplicación
	current_path = ""
	*-- Indica si el archivo ejecutable corresponde a cuenta 1 o 2. .T. = Cuenta 1 / .F. = Cuenta 2
	es_cuenta_1 = .F.
	*-- Verifica si hay una nueva versión de sistema
	version_actual = ""
	Name = "cls_update_version"


	*-- Permite actualizar la versión del sistema
	...
	*-- Permite buscar una actualización del sistema.
	PROTECTED PROCEDURE obtener_actualizacion
		************************************************************
	...
	*-- Permite verificar la versión actual del ejecutable.
	PROTECTED PROCEDURE hay_version_nueva
		******************************************************************
	...
	*-- Permite actualizar el archivo ejecutable.
	PROTECTED PROCEDURE actualizar_ejecutables
		******************************************************************
	...
	*-- Verifica que el compartido esté visible.
...
ENDDEFINE
*
*-- EndDefine: cls_update_version
**************************************************


**************************************************
*-- Class:        cls_update_version_bd (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- ParentClass:  custom
*-- BaseClass:    custom
*-- Time Stamp:   12/02/25 09:54:02 AM
*
DEFINE CLASS cls_update_version_bd AS custom


	Height = 16
	Width = 100
	*-- Indica si tiene que buscar los scripts SQL en modo desarrollo o en producción
	upd_sql_loc = .F.
	*-- Contiene la ruta donde se encuentran los scripts SQL a ejecutar o actualizar.
	upd_sql_path = ""
	*-- Indica si está en modo_desa
	modo_desa = .F.
	*-- Contiene el mensaje de error en caso de un fallo
	error_message = ""
	*-- Contiene el nombre del archivo script que se tiene que ejecutar la iniciar el sistema en caso de que exista.
	upd_script_filename = ""
	...
	*-- Permite actualizar los procedimientos almacenados o funciones.
	HIDDEN PROCEDURE ejecutar_upd_spfn
		************************************************************************
	...
	*-- Permite actualizar procedimientos almacenados o funciones.
	PROTECTED PROCEDURE actualizar_spfn
		*-------------------------------------------------------------------------
	...
	*-- Permite realizar la configuración básica de la base de datos para desarrollo independientemente del cliente.
	PROTECTED PROCEDURE configurar_sistema
		******************************************************************************
	...
	*-- Ejecuta un comando SQL
	PROTECTED PROCEDURE ejecutar_comando
		**********************************************************************************
	...
	*-- Crea o actualiza el SP agregar_menu
	PROTECTED PROCEDURE instalar_agregar_menu
		***************************************************************
		* Crea o actualiza el SP agregar_menu
		***************************************************************
	...
	*-- Verifica si un campo existe o no. Devuelve .T. si existe y .F. en caso contrario
	PROTECTED PROCEDURE existe_campo
		*******************************************************************************
	...
	*-- Agrega el campo y los valores a sitiva
	...
	*-- Permite instalar la tabla de tipos de pagos
	...
	*-- Agrega parámetros que no existen en la global_cfg con un valor por defecto y con modificar en 0 para que cada vez que se inicie el sistema no modifique el valor configurado.
...
ENDDEFINE
*
*-- EndDefine: cls_update_version_bd
**************************************************


**************************************************
*-- Class:        cls_update_logistica (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- ParentClass:  cls_update_version_bd (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- BaseClass:    custom
*-- Time Stamp:   12/17/25 05:43:14 PM
*
DEFINE CLASS cls_update_logistica AS cls_update_version_bd
	...
	*-- Permite crear la tabla de remitos
	HIDDEN PROCEDURE crear_tabla_remito
		**************************************************************
		* Permite crear la tabla de remitos.
...
ENDDEFINE
*
*-- EndDefine: cls_update_logistica
**************************************************


**************************************************
*-- Class:        cls_update_tabla_arca (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- ParentClass:  cls_update_version_bd (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- BaseClass:    custom
*-- Time Stamp:   08/27/25 05:29:04 PM
*
DEFINE CLASS cls_update_tabla_arca AS cls_update_version_bd


	Name = "cls_update_tabla_arca"


	*-- Permite actualizar las unidades de medidas.
...
ENDDEFINE
*
*-- EndDefine: cls_update_tabla_arca
**************************************************


**************************************************
*-- Class:        cls_update_version_articulos (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- ParentClass:  cls_update_version_bd (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- BaseClass:    custom
*-- Time Stamp:   05/30/25 09:40:02 AM
*
DEFINE CLASS cls_update_version_articulos AS cls_update_version_bd


	Name = "cls_update_version_articulos"


	*-- Permite agregar campos a la tabla de artículos
...
ENDDEFINE
*
*-- EndDefine: cls_update_version_articulos
**************************************************


**************************************************
*-- Class:        cls_update_version_ventas (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- ParentClass:  cls_update_version_bd (d:\sistemas\lg-v1\clases\generics\update_version_utils.vcx)
*-- BaseClass:    custom
*-- Time Stamp:   11/21/24 11:59:13 AM
*
DEFINE CLASS cls_update_version_ventas AS cls_update_version_bd


	Name = "cls_update_version_ventas"


	*-- Permite instalar la tabla de pedidos externos inválidos.
...
ENDDEFINE
*
*-- EndDefine: cls_update_version_ventas
**************************************************
